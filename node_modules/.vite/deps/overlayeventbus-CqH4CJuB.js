import { At$1 as At, s$1 } from "./dist-6h0Ad9Ko.js";
import { s } from "./eventbus-B_YnctEL.js";
...
var ConnectedOverlayScrollHandler = /* @__PURE__ */ function() {
	function ConnectedOverlayScrollHandler$1(element) {
		var listener = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : function() {};
		_classCallCheck$1(this, ConnectedOverlayScrollHandler$1);
		this.element = element;
		this.listener = listener;
	}
	return _createClass$1(ConnectedOverlayScrollHandler$1, [
		{
	...
	return _createClass(_default$1, [
		...
		},
		{
			...
			value: function get(parentInstance, slots) {
				...
				return s$1(computed) ? computed : null;
			}
		},
		{
			key: "_isMatched",
		...
		},
		{
			...
			value: function _recursive() {
				...
				children.forEach(function(child) {
					if (child.children instanceof Array) components = components.concat(_this._recursive(helpers, child.children));
					else if (child.type.name === _this.type) components.push(child);
					else if (s$1(child.key)) components = components.concat(helpers.filter(function(c) {
...
//#endregion
export { ConnectedOverlayScrollHandler, OverlayEventBus, _default, getVNodeProp };
//# sourceMappingURL=overlayeventbus-CqH4CJuB.js.map