import { A, E, S, T, Y$2 as Y, _t, ar, m, s$1 as s, tt } from "./dist-6h0Ad9Ko.js";
import { getCurrentInstance, nextTick, onMounted, readonly, ref, watch } from "./vue.runtime.esm-bundler-Blo0xbV0.js";
...
function useStyle(css) {
	...
	var load = function load$1(_css) {
		...
		styleRef.value = document.querySelector("style[data-primevue-style-id=\"".concat(_name, "\"]")) || document.getElementById(_id$1) || document.createElement("style");
...
var BaseStyle = {
	...
	load: function load(style$1) {
		...
		return s(computedStyle) ? useStyle(Y(computedStyle), _objectSpread({ name: this.name }, options)) : {};
	},
...
//#endregion
export { BaseStyle };
//# sourceMappingURL=style-CD3-pDxX.js.map