import { C$1 as C, C$2 as C$1, F, K, N, P, Q$1 as Q, Rt, S, Tt, U, W, a, c$1 as c, g, i, l, m, ne$1 as ne, s, v } from "./dist-6h0Ad9Ko.js";
import { mergeProps } from "./vue.runtime.esm-bundler-Blo0xbV0.js";
import { Base } from "./basecomponent-B5ovRQM_.js";
import { BaseStyle } from "./style-CD3-pDxX.js";
import { PrimeVueService } from "./service-C1v44yBT.js";
...
function _unsupportedIterableToArray$1(r, a$1) {
	if (r) {
		if ("string" == typeof r) return _arrayLikeToArray$1(r, a$1);
		var t = {}.toString.call(r).slice(8, -1);
		return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray$1(r, a$1) : void 0;
	}
}
function _arrayLikeToArray$1(r, a$1) {
...
var BaseDirective = {
	...
	_getPTValue: function _getPTValue() {
		...
		var getValue = function getValue$1() {
			var value = BaseDirective._getOptionValue.apply(BaseDirective, arguments);
			return a(value) || C$1(value) ? { "class": value } : value;
		};
	...
	_getPT: function _getPT(pt) {
		...
		var getValue = function getValue$1(value) {
	...
	_usePT: function _usePT() {
		...
		var fn = function fn$1(value$1) {
			return callback(value$1, key, params);
		};
	...
	_loadThemeStyles: function _loadThemeStyles() {
		...
		if (!S.isStyleNameLoaded("common")) {
			...
			var _ref5 = ((_instance$$style4 = instance.$style) === null || _instance$$style4 === void 0 || (_instance$$style4$get = _instance$$style4.getCommonTheme) === null || _instance$$style4$get === void 0 ? void 0 : _instance$$style4$get.call(_instance$$style4)) || {}, primitive = _ref5.primitive, semantic = _ref5.semantic, global = _ref5.global, style$1 = _ref5.style;
			...
			BaseStyle.loadStyle(_objectSpread({ name: "global-style" }, useStyleOptions), style$1);
	...
	_extend: function _extend(name) {
		...
		var handleHook = function handleHook$1(hook, el, binding, vnode, prevVnode) {
		...
		var handleWatchers = function handleWatchers$1(el) {
			...
			var handleWatchConfig = function handleWatchConfig$1(_ref8) {
			...
			var handleWatchConfigRipple = function handleWatchConfigRipple$1(_ref9) {
		...
		var stopWatchers = function stopWatchers$1(el) {
	...
	extend: function extend() {
		...
		return _objectSpread({ extend: function extend$1() {
...
//#endregion
export { BaseDirective, Ripple };
//# sourceMappingURL=ripple-d1oQwNSz.js.map